...
Django Authentication & Autorization Service with React Frontend and serverside rendering
...
```
1. You need to have docker install
...
```
Run the command cd django-auth-service
```
